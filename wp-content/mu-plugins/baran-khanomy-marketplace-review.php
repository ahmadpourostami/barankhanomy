...
add_action( 'wp_head', function() {
    ...
    <style id="bk-marketplace-review">
        ...
        .bk-marketplace-heading>span{display:inline-block;width:max-content;margin:0 auto 7px;padding:5px 13px;border-radius:999px;background:#f2eafa;color:var(--bk-purple);font-size:13px;line-height:1.5;font-weight:800}
        ...
        .bk-market-track{align-items:stretch}
        ...
        .bk-market-rating{font-size:12px}.bk-market-rating small{font-size:10px}
        ...
        .bk-market-track:has(.bk-market-card:only-child){justify-content:center}
        .bk-market-track:has(.bk-market-card:only-child) .bk-market-card{flex-basis:min(100%,320px)}
        ...
        @media(max-width:760px){
            .bk-marketplace-home{padding:52px 0 58px}.bk-marketplace-heading{margin-bottom:22px}
            .bk-marketplace-heading>span{font-size:13px}.bk-marketplace-heading h2{font-size:24px}.bk-marketplace-heading p{font-size:13px}
            .bk-market-card-image{height:230px}.bk-market-card h3{font-size:15px}.bk-market-excerpt{font-size:13px}.bk-market-cart{font-size:12px}.bk-market-controls{gap:8px}
            .bk-market-track:has(.bk-market-card:only-child) .bk-market-card{flex-basis:100%}
        }
    </style>
    <?php
}, 121 );
