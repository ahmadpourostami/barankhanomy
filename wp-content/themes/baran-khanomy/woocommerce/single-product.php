...
<button type="button" class="bk-market-single-wishlist" aria-label="افزودن به علاقه‌مندی" data-product-id="<?php echo esc_attr( $product->get_id() ); ?>">♡</button>
...
<div class="bk-market-single-guarantee"><span>♡</span><div><strong>خریدی مطمئن</strong><small>محصول دست‌ساز با عشق آماده شده است</small></div></div>
</div>
</div>
<div class="bk-market-benefits"><div><span>♧</span><strong>محصول دست‌ساز</strong><small>ساخته شده با عشق</small></div><div><span>✦</span><strong>کیفیت تضمین‌شده</strong><small>انتخاب با خیال راحت</small></div><div><span>↩</span><strong>ضمانت بازگشت</strong><small>طبق شرایط فروشگاه</small></div><div><span>♧</span><strong>ارسال سریع</strong><small>ارسال به سراسر کشور</small></div></div>
...
<div id="description" class="bk-market-tab-content"><div class="bk-market-description-copy"><?php the_content(); ?></div><div class="bk-market-highlight"><div><span>✦</span><strong>الهام از طبیعت</strong><small>طراحی شده با توجه به زیبایی طبیعت</small></div><div><span>♡</span><strong>ساخته شده با عشق</strong><small>هر محصول با دقت و ظرافت آماده شده است</small></div><div><span>◇</span><strong>منحصربه‌فرد</strong><small>هیچ دو محصولی کاملاً مشابه نیستند</small></div></div></div>
