...
<div><span class="bk-market-icon" data-bk-icon-key="bk_icon_product_handmade" aria-hidden="true"><?php echo function_exists( 'bk_get_custom_icon' ) ? bk_get_custom_icon( 'bk_icon_product_handmade' ) : '<svg viewBox="0 0 24 24"><path d="M20 7.5 12 3 4 7.5v9L12 21l8-4.5v-9ZM12 3v18M4 7.5l8 4.5 8-4.5"/></svg>'; ?></span><div><strong>محصول دست‌ساز</strong><small>ساخته شده با عشق</small></div></div>
<div><span class="bk-market-icon" data-bk-icon-key="bk_icon_product_quality" aria-hidden="true"><?php echo function_exists( 'bk_get_custom_icon' ) ? bk_get_custom_icon( 'bk_icon_product_quality' ) : '<svg viewBox="0 0 24 24"><path d="m12 3 2.35 4.76 5.25.76-3.8 3.7.9 5.23L12 15l-4.7 2.45.9-5.23-3.8-3.7 5.25-.76L12 3Z"/></svg>'; ?></span><div><strong>کیفیت تضمین‌شده</strong><small>انتخاب با خیال راحت</small></div></div>
<div><span class="bk-market-icon" data-bk-icon-key="bk_icon_product_return" aria-hidden="true"><?php echo function_exists( 'bk_get_custom_icon' ) ? bk_get_custom_icon( 'bk_icon_product_return' ) : '<svg viewBox="0 0 24 24"><path d="M9 7H5a2 2 0 0 0-2 2v2"></path><path d="m6 6-3 3 3 3"></path><path d="M3 9h10a7 7 0 0 1 7 7v2"/></svg>'; ?></span><div><strong>ضمانت بازگشت</strong><small>طبق شرایط فروشگاه</small></div></div>
<div><span class="bk-market-icon" data-bk-icon-key="bk_icon_product_shipping" aria-hidden="true"><?php echo function_exists( 'bk_get_custom_icon' ) ? bk_get_custom_icon( 'bk_icon_product_shipping' ) : '<svg viewBox="0 0 24 24"><path d="M3 6h11v10H3zM14 9h4l3 3v4h-7z"></path><circle cx="7" cy="18" r="2"></circle><circle cx="18" cy="18" r="2"></circle></svg>'; ?></span><div><strong>ارسال سریع</strong><small>ارسال به سراسر کشور</small></div></div>
</div>
