...
<header class="bk-header">
  <div class="bk-container bk-header-inner">
    ...
    <nav class="bk-nav" aria-label="منوی اصلی">
      <a href="#courses">دوره‌ها</a><a href="#categories">دسته‌بندی</a><a href="#mentors">مسیر یادگیری</a><a href="#about">درباره من</a><a href="#blog">وبلاگ</a><a href="#contact">تماس با من</a>
    </nav>
